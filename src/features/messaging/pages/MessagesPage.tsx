...
export function MessagesPage() {
  ...
  return (
    <>
      ...
      <div className="messaging-page-enter flex h-full pr-10 min-h-0 w-full overflow-hidden rounded-2xl border border-gray-200 bg-white shadow-sm md:rounded-3xl dark:border-gray-800 dark:bg-gray-900">
        <div className={`${sidebarVisibleClass} w-full md:w-1/3 lg:w-80`}>
          <InboxSidebar
            view={activeTab}
